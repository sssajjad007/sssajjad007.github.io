...
const MY_PROJECTS: Array<Project> = [
	{
		...
		shortDescription:
			'Alopeyk is a technology company that provides on-demand delivery services. It is the first and largest provider of on-demand delivery services in Iran.',
		links: [{ to: 'https://cafebazaar.ir/app/com.alopeyk.courier', label: 'CafeBazaar' }],
		logo: Assets.Courier,
	...
	},
	{
		...
		shortDescription:
			'Alopeyk is a technology company that provides on-demand delivery services. It is the first and largest provider of on-demand delivery services in Iran.',
		links: [
			{ to: 'https://cafebazaar.ir/app/com.alopeyk.customer', label: 'CafeBazaar' },
			{
...

	{
		...
		links: [{ to: 'https://cafebazaar.ir/app/com.vendorapp', label: 'CafeBazaar' }],
		logo: Assets.Vendor,
	...
	},
	{
		...
		links: [{ to: 'https://sibapp.com/applications/OnlineDelino', label: 'Sibapp' }],
		logo: Assets.Delino,
	...
	},
	{
		...
		<ul/>`,
		shortDescription: 'Vendo Application: online food ordering and delivery platform.',
		links: [],
		logo: Assets.Vendo,
	...
	},
	{
		...
		<ul/>`,
		shortDescription: 'Development of the new version of the Denj application as a freelancer',
		links: [
			{
	...
	},
	{
		...
		links: [{ to: 'https://github.com/sssajjad007/react-native-psychology-app', label: 'Github' }],
		logo: Assets.Taskyn,
